      ...
      {weather &&
          <div className={matches? "weatherMobile":"weather"}>
            <div className={matches? "weatherMobileFather":"imgWeatherFather"}>
              ...
              <div
                className={
                  matches ? "weatherOtherFatherMobile" : "weatherOtherFather"
                }
              >
            ...
            >
              <div className={matches ? "ulFatherMobile" : "ulFather"}>
                <div>
                  {matches && (
                    <ul>
                      <li className="liHome" onClick={() => history.push("/")}>
                        Home
                      </li>
                    </ul>
                  )}
              ...
              <div
                className={
                  dropdown.cat
                    ? "openDropDown"
                    : matches
                    ? "closedDropDownMobile"
                    : "closeDropDown"
                }
                onClick={() => {
                  dropdown.cat
                    ? setDropdown({ cat: false, lang: false, countries: false })
                    : setDropdown({ cat: true, lang: false, countries: false });
                }}
              >
                categories
                {dropdown.cat ? (
                  <div
                    className={matches ? "dropopenSignMobile" : "dropopenSign"}
                  ></div>
                ) : (
                  <div
                    className={
                      matches ? "dropcolseSignMobile" : "dropcloseSign"
                    }
                  ></div>
                )}
              </div>
              ...
              <div className={matches ? "ulFatherMobile" : "ulFather"}>
                {dropdown.cat && (
                  <ul className={matches ? "dropdownUlMobile" : "dropdownUl"}>
                    <li
                      className={matches ? "liMobile" : "categoryLi"}
                      onClick={() => {
                        history.push({
            ...
            >
              <div
                ...
                onClick={() => {
                  dropdown.lang
                    ? setDropdown({ cat: false, lang: false, countries: false })
                    : setDropdown({ cat: false, lang: true, countries: false });
                }}
              >
                Languages
                {dropdown.lang ? (
            ...
            >
              <div
                ...
                onClick={() => {
                  dropdown.countries
                    ? setDropdown({ cat: false, lang: false, countries: false })
                    : setDropdown({ cat: false, lang: false, countries: true });
                }}
              >
                Countries
                {dropdown.countries ? (
