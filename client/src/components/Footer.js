      ...
      <div className="copyrightFather">
        <div className="rightFooter">
          <div className="aboutUs">
            <p className="aboutustext" style={centerText}>
              ABOUT US
            </p>
            <p className="aboutustext" style={centerText}>
              NUNTUINM NEWS
        ...
        <div className="midFooter">
          ...
          <div className="copyright">
            <p style={{ wordSpacing: "5px", margin: "auto", color: "white" }}>
              Powered By{" "}
              <a
                onMouseOver={() => {
                  setHover(true);
            ...
            <p style={{ wordSpacing: "5px" }} className="copyrightinfo">
              Made by Ahmed & Omar at DCI © 2021
            </p>
            <p style={wordSpace} className="copyrightreserve">
              All rights reserved
            </p>
          </div>
        </div>
