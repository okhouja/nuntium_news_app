...
function Header() {
  ...
  useEffect(() => {
    axios
      ...
      .then((data) => setWeatherNow(data.data.current));
  }, []);
  ...
  useEffect(() => {
    axios
      .get(
        `http://api.weatherapi.com/v1/forecast.json?Key=${API_KEY}&q=hamburg`
      )
      .then((data) => setWeather(data.data.forecast.forecastday[0].day));
  }, []);
  console.log(weather);
        ...
        <div className="headerFather">
          <div className="weather">
            ...
            <div className="fatherCurrentWeather">
              ...
              <div className="currentFather">
                <label style={{ marginLeft: "2vh" }} className="currentLabel">
                  Low
                </label>
                <span style={{ marginLeft: "2vh" }} className="currentData">
                  {weather.mintemp_c}
                </span>
              </div>
              <div className="currentFather">
