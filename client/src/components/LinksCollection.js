    ...
    <div className="linkContainer">
      <div className="linkFather">
        ...
        <div className="linkmidContainer">
          <div className="linkmidFather">
            <div className="linkInfo">
              <p className="linkAuthorWord">Author:</p>
              <p className="linkAuthor">{linkArr.author}</p>
            </div>
            <div className="linkInfo">
              <p className="linkAuthorWord">Source:</p>
              <p className="linkAuthor">{linkArr.source}</p>
            </div>
          </div>
          <div>
        ...
        <div className="seemoreFather">
          <div className="linkDes">{linkArr.description} </div>
          <div className="linkInfo">
            <a href={linkArr.url}>See more</a>
          </div>
        </div>
        <div className="backFather">
          ...
          <div className="goUpRedirect">
            <a className="goUpanchor" href="#img">
              ˄
            </a>
          </div>
