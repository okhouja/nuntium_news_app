 ...
 const Sports = () => {
  ...
  const businessNews = business.map((value,i)=>{
    ...
    return(
                 ...
                 <img className={i === 0? "imgActive" : "businessimg"} src={image} alt={title} width="200px" height="250px"   />    
                      <div className="businessOthers">
                       <h3 className={i == 0  && contextObj.store === "light"? "generalTitleActive":"generalTitleActiveDark", contextObj.store === "light"? "generalTitle": "sportTitleDark"}
                       onClick={()=>
                        {if(i === 0 || i){
                       ...
                       <p className={i === 0 && contextObj.store === "lighjt"? "generalPublishActive":"generalPublishActiveDark",contextObj.store === "light"?  "generalPublish":"generalPublishDark"}>{published_at}</p> 
                        ...
                        <div className={i === 0?  "businessContainerActive": "businessContainer"}>
                             ...
                             ><p className={ i === 0 && contextObj.store ==="light"?  "businessAuthorWordActive":"businessAuthorWordActiveDark", contextObj.store ==="light"? "businessAuthorWord":"businessAuthorWordDark"}>Author: </p>
                              <p className={ i === 0 && contextObj.store === "light"?  "businessAuthorActive":"businessAuthorActive",contextObj.store === "light"? "businessAuthor":"businessAuthorDarks"}> {author}</p></div>
                              <div  className={i === 0? "businessAuthorFatherActive" : "businessAuthorFather"}>
                               <p className={ i === 0 && contextObj.store === "light" ? "businessAuthorWordActive":"businessAuthorWordActiveDark", contextObj.store === "light"? "businessAuthorWord":"businessAuthorWordDark"} >Source: </p> 
                               <p className={ i === 0 && contextObj.store === "light"? "businessAuthorActive":"businessAuthorActiveDark", contextObj.store ==="light"?"businessAuthor":"businessAuthordark"}> {source}</p></div>
                               </div>  
                             </div> 
                             </div>
                     </div>           
    ...
    return (
     <div >
            ...
            state: {category:"sports"}})} id="business"   className={contextObj.store === "dark"? "generalDark":"general"}>BUSINESS</div> 
